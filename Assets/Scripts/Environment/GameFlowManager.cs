...
using UnityEngine.SceneManagement;
    ...
    // Add these methods to your GameFlowManager.cs script
    // Make sure you have 'using UnityEngine.SceneManagement;' at the top of the file
    ...
    {
        // IMPORTANT: Replace "MainScene" with the actual name of your main gameplay scene file
